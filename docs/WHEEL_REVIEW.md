...
| 3. Prediction | Predict what verification will reveal | Smoke test passes; analytics over-counts; E-Prime **flagged** as false positive; READMEs lack extends declarations |
